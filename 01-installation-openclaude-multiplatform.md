...
- [`02-tutoriel-agent-local-llamacpp-avance.md`](./02-tutoriel-agent-local-llamacpp-avance.md) — la version avancée avec `llama.cpp` compilé à la main (CUDA, plus de contrôle)
- [`docs/00-installation-windows-ollama-gguf.md`](../00-installation-windows-ollama-gguf.md) — utiliser un GGUF custom de Hugging Face avec Ollama
- [`docs/05-guide-utilisation.md`](../05-guide-utilisation.md) — comment utiliser OpenClaude au quotidien
